   ...
   <script src="vendor/all.min.js"></script>
    ...
    <div class="nav-control">
        <div class="hamburger">
                                ...
                                <div class="table-responsive recentOrderTable">
                                    <table class="table verticle-middle table-responsive-md">
                                        ...
                                        <tbody>
                                            ...
                                            $req = mysqli_query($bdd, "SELECT * FROM etudiant WHERE Formation = 'Secrétariat bureautique(SB)' or Formation = 'Secrétariat de Direction(SD)'");
            ...
            <center><a class="btn btn-dark" id="btn" href="liste_p_B.php?id= <?php echo $userinfo['id']; ?>">Imprimer</a></center>
            <br>
            <br>
        </div>
